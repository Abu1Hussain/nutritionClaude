...
class _NutriVisionRootState extends State<NutriVisionRoot> {
  ...
  Future<(AppState, FoodRepository, BoxStore)> _init() async {
    ...
    return (
      appState,
      results[1] as FoodRepository,
      BoxStore(await SharedPreferences.getInstance()),
    );
  }
      ...
      builder: (context, snapshot) {
        ...
        return MultiProvider(
          providers: [
            ...
            ChangeNotifierProvider<BoxStore>.value(value: boxStore),
          ],
      ...
      destinations: [
        NavDestinationSpec(
          ...
          builder: (context) => HomeScreen(
            onGoToRewards: () => _scaffoldKey.currentState?.navigateTo(5),
          ),
        ),
        NavDestinationSpec(
          label: 'Calculator',
            ...
            IconButton(
              ...
              onPressed: () => Navigator.of(context).push(
                MaterialPageRoute<void>(
                  builder: (_) => _MainShell(foodRepo: widget.foodRepo),
                ),
              ),
            ),
            IconButton(
